...
it('AoC 2021: day07', () => {
  expect(part1(readFile('example-input.txt')), 'part1: example-input.txt').to.equal(37);
  expect(part1(readFile('input.txt')), 'part1: input.txt').to.equal(347449);
  expect(part2(readFile('example-input.txt')), 'part2: example-input.txt').to.equal(168);
