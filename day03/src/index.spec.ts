...
it('AoC 2021: day03', () => {
  expect(part1(readFile('example-input.txt')), 'part1: example-input.txt').to.equal(198);
  expect(part1(readFile('input.txt')), 'part1: input.txt').to.equal(2743844);
  expect(part2(readFile('example-input.txt')), 'part2: example-input.txt').to.equal(230);
